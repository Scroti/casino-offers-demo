...
export const metadata = genMeta({
  ...
  description:
    'Discover the best online casino bonuses, reviews, and free games. Find exclusive offers, trusted casino reviews, and play free casino games. Your trusted guide for safe and secure online gambling.',
