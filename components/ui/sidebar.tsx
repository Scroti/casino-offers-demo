...
function SidebarFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="footer"
      className={cn("flex flex-col gap-2 p-2 mb-5", className)}
      {...props}
    />
  );
}
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        // Don't hide on mobile - always show labels when mobile sidebar is open
        isMobile ? "" : "group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0",
        className
      )}
      {...props}
    />
